...
?>
  <tr class="form-field  newfield_get field_index_<?php echo $i?>" data-no="<?php echo $i;?>" data-counter="<?php echo $counter;?>">
	...
	<td><input type="text" name="question_<?php echo $i;?>" value="<?php echo $question_data_get[$i]?>"></td>
    <td><textarea type="text" name="answer_<?php echo $i;?>"><?php echo $answers_data_get[$i];?></textarea></td>	
